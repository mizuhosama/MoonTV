  ...
  return (
    <PageLayout>
        ...
        <div className="mx-auto max-w-[95%]">
          {activeTab === 'favorites' ? (
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-3 justify-start gap-x-2 gap-y-14 px-2 sm:grid-cols-[repeat(auto-fill,_minmax(11rem,_1fr))] sm:gap-x-8 sm:gap-y-20 sm:px-4">
      ...
      {announcement && showAnnouncement && (
        <div
          className={`fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm transition-opacity duration-300 dark:bg-black/70 ${
            showAnnouncement ? '' : 'pointer-events-none opacity-0'
          }`}
        >
          <div className="w-full max-w-md transform rounded-xl bg-white p-6 shadow-xl transition-all duration-300 hover:shadow-2xl dark:bg-gray-900">
            <div className="mb-4 flex items-start justify-between">
              ...
              <button
                ...
                className="text-gray-400 transition-colors hover:text-gray-500 dark:text-gray-500 dark:hover:text-white"
                aria-label="关闭"
              ></button>
            </div>
            <div className="mb-6">
