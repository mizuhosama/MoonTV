...
function PlayPageClient() {
          ...
          <div className="mx-auto max-w-md px-6 text-center">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full transform rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-3 font-medium text-white shadow-lg transition-all duration-200 hover:scale-105 hover:from-green-600 hover:to-emerald-700 hover:shadow-xl"
              >
  ...
  return (
    <PageLayout activePath="/play">
      <div className="flex flex-col gap-3 px-5 py-4 lg:px-10 xl:px-20">
        {/* 第一行：影片标题 */}
        <div className="py-1">
        ...
        <div className="space-y-2">
          ...
          >
            ...
            >
              <div
                ref={artRef}
                className="h-[300px] w-full overflow-hidden rounded-xl border border-white/0 bg-black shadow-lg dark:border-white/30 lg:h-full"
              ></div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          ...
          <div className="hidden md:order-first md:col-span-1 md:block">
            <div className="py-4 pl-0 pr-6">
              <div className="flex aspect-[3/4] items-center justify-center overflow-hidden rounded-xl bg-gray-300 dark:bg-gray-700">
                {videoCover ? (
                  <img
                    src={videoCover}
                    alt={videoTitle}
